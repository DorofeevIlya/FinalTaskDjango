"""
Django settings for list_recipes project.
...
MYSQL_PASSWORD = '9d9a9r9a'
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-!xvs012=jjx=d7*hh%4gs1xd3q+$m(mnt6^m1%r=rmxcfu8h3a'
...
INTERNAL_IPS = ['127.0.0.1', 'dorofey09.pythonanywhere.com']
...
ROOT_URLCONF = 'list_recipes.urls'
